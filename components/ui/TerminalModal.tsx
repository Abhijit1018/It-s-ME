...
const COMMANDS: Record<string, () => string[]> = {
  ...
  projects: () => [
    ...
    "02  Numen           — SAP enterprise intelligence, 17 agents",
    "03  WhiteWire       — AI-native canvas for product teams",
    "04  Arora AI        — autonomous Python agent",
    "05  Bharat Biz      — Hindi/Hinglish voice assistant",
    "06  MindInspo       — AI idea incubator",
    "07  REDHOPE         — blood & organ logistics",
    "08  ShieldRoute     — TypeScript RBAC routing framework",
    "09  Nexus OS        — browser OS in TypeScript",
    "",
